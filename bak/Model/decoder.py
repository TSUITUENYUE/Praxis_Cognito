...
class Decoder(nn.Module):
    def __init__(self, latent_dim, seq_len, object_dim, joint_dim, urdf, hidden_dim):
    ...
    def forward(self, z):
        ...
        return combined_traj.permute(1, 0, 2), joint_traj.permute(1, 0, 2)