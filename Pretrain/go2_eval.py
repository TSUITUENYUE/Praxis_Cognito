...
def main():
    ...
    parser.add_argument("--config", type=str, default="../conf/5go2contact.yaml", help="unified YAML config, e.g. ./conf/go2pos.yaml")
    parser.add_argument("-e", "--exp_name", default="5go2contact",type=str,help="experiment name under Pretrain/primitives/")
